<script setup lang="ts">
    ...
    //     return event.target.classList.toggle("tabActive")
    // }
    function deActivate() {
...
<template>
    <div class="text-lime-500 uppercase text-center">
        ...
        <div class="bg-gray-950">
            ...
            <div class="tabs carousel place-content-center flex-wrap">
                <button
                    ...
                    ref="tabs"
                    :key="index"
                    class="carousel-item tabLifted tab-md text-lime-500 font-semibold uppercase"
