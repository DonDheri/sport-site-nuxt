...
<template>
    <div id="div" class="">
        ...
        <NuxtLink v-for="league in leagues" :to="`/${sportSlug}/game/${league.slug}`"  class="bg-info-content w-full inline-flex items-center">
            <div class="flex content-center bg-black h-[25px] w-[25px] rounded-full  mr-3"></div>
            <p> Europe / UEAFA Champions League</p>
        </NuxtLink>
        <NuxtLink :to="`/${sportSlug}/league/${game.slug}`" class="grid grid-cols-12" v-for="game in games">
