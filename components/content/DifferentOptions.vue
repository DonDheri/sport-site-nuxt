...
<template>
    ...
    <div v-if="useRoute().path=='/'||`/content/${props.sports.id}`||`/content/${props.sports.id}/${props.sports.leagues}`" class="border-2 mx-48 grid grid-cols-12 grid-rows-2 gap-5 overflow-x-scroll px-10 pb-5 rounded-xl my-6">
